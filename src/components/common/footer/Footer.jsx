...
import footerImg from "../../../assets/Home-Page/Footer/footerimg.webp";
import { Link } from "react-router-dom";

const Footer = () => {
  return (
    <div className="bg-[#fff]">
      <div className="px-4 mx-auto max-w-full md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 py-5">
          ...
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-3 md:grid-cols-3 text-center">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <address>
                    30355 SE Highpoint Way <br /> Preston, WA 98050
                  </address>
                </li>
              </ul>
            </div>
