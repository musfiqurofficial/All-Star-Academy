...
const Contact = () => {
  return (
    <div>
      <GoogleMap></GoogleMap>
      <div className="px-4 mx-auto max-w-full md:max-w-full lg:max-w-screen-lg lg:px-10 py-20">
        <section className="main_form flex flex-col md:flex-row">
          <div className="from_section p-5">
            ...
            <p className="mb-9">
              Please fill out the contact form below detailing your inquiry and
