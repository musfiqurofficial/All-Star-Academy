      ...
      <div className="px-4 mx-auto max-w-full md:max-w-full lg:max-w-screen-xl md:px-18 lg:px-8">
        ...
        <div className="grid grid-cols-2">
          ...
          <div className="flex flex-col gap-y-6 items-center">
            <h2 className="text-end text-[32px] font-semibold drop-shadow-xl ml-60">
              - Monday -
            </h2>
            <p className="border-4 rounded-full border-[#4EBA59] py-4 rounded-r-none w-full sm:w-9/12 px-7 ml-56 text-center text-base">
              <span className="font-medium text-[20px]">
                Team Sports & Playground* 3:45-4:45p
              </span>{" "}
              <br />
              At the 5 acre Preston Athletic Fields and Park <br /> across the
              street.
            </p>

            <div className=" ml-52 p-2 shadow-md shadow-slate-300">
              <img
                className="mb-4 w-[338px] h-[425px] "
                src={mon2}
                alt=""
                srcset=""
              />
          ...
          <div className="flex flex-col gap-y-6">
            <div className="ml-4 p-2 pb-5 shadow-md shadow-slate-300 w-[338px]  h-[425px] ">
              <img className="mb-4" src={mon1} alt="" srcset="" />
              <p className="text-center">*Weather Depending</p>
            </div>

            <p className="-z-10 -ml-8 mt-10 border-4 rounded-full border-[#4EBA59] py-4 rounded-l-none w-9/12  px-6 mr-64 text-center text-base">
              <span className="font-medium text-[20px]">
        ...
        <div className="grid grid-cols-2 my-20">
          ...
          <div className="flex flex-col gap-y-6 items-center">
            ...
            <p className="border-4 rounded-full border-[#4EBA59] py-4 rounded-r-none w-9/12 px-5 ml-60 text-center text-base">
              ...
              <br />
              How to make a film A-Z. Kids are grouped <br /> for
          ...
          <div className="flex flex-col gap-y-6">
            <div className="ml-4 p-2 w-[338px] h-[425px]  shadow-md shadow-slate-300">
              <img className="mb-10" src={tuesday2} alt="" srcset="" />
              <p className="text-center">*Weather Depending</p>
            </div>

            <p className="-z-10 -ml-8 mt-10 border-4 rounded-full border-[#4EBA59] py-3 rounded-l-none w-9/12  px-6 mr-64 text-center text-base">
              <span className="font-medium text-[20px]">
                Alternative: Trampolines, Art, Free-play!
              </span>{" "}
              <br />
        ...
        <div className="grid grid-cols-2 my-20">
          ...
          <div className="flex flex-col gap-y-6 items-center">
            ...
            <p className="border-4 rounded-full border-[#4EBA59] py-4 rounded-r-none w-9/12 px-6 ml-56 text-center text-base">
              ...
              <br />
              On-site in our horse paddock & on the <br /> Preston-Fall City
              Trail!
            </p>
          ...
          <div className="flex flex-col gap-y-6">
            <div className="ml-4 p-2  w-[338px] h-[425px]  shadow-md shadow-slate-300">
              <img className="mb-10" src={wed1} alt="" srcset="" />
              <p className="text-center">*Weather Depending</p>
            </div>

            <p className="-z-10 -ml-8 mt-10  border-4 rounded-full border-[#4EBA59] py-4 rounded-l-none w-10/12  px-5 text-center text-base">
              <span className="font-medium text-[20px]">
                Optional**: Cognitive Ability Training
              </span>{" "}
              <br />
              Guaranteed to improve executive processing, processing <br />{" "}
              speed, attention control, learning speed, and memory <br />{" "}
              recall.{" "}
              <a
                className="text-blue-400 underline"
                href="https://allstarkiddos.lpages.co/festival-school-interest-form/"
              >
                {" "}
                Click here{" "}
              </a>{" "}
              to download the info packet.
            </p>
        ...
        <div className="grid grid-cols-2 my-20">
          ...
          <div className="flex flex-col gap-y-6 items-center">
            ...
            <p className="border-4 rounded-full border-[#4EBA59] py-4 rounded-r-none w-10/12 px-5 ml-56 text-center text-base">
              <span className="font-medium text-[20px]">
                Nature Day with Horses!* 3:45-4:45p
              </span>{" "}
              <br />
              We take the horses on the Preston-Fall City Trail
              <br /> and take turns hiking, horseback riding, and <br /> leading
              our miniature horse.
            </p>
          ...
          <div className="flex flex-col gap-y-6">
            ...
            <p className="-z-10 -ml-8 mt-10  border-4 rounded-full border-[#4EBA59] py-4 rounded-l-none w-9/12  px-6 mr-64 text-center text-base">
              ...
              <br />
              In our classrooms. Free-play and trampolines <br /> are also an
              available!
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 my-20">
          ...
          <div className="flex flex-col gap-y-6">
            ...
            <p className="-z-10 -ml-8 mt-10 border-4 rounded-full border-[#4EBA59] py-4 rounded-l-none w-8/12  px-5 text-center text-base">
              <span className="font-medium text-[20px]">
                Alternative: Movie + popcorn!
              </span>{" "}
              <br />
              In our classrooms. Free-play and <br /> trampolines are also an
              option!
            </p>
          </div>
        </div>
