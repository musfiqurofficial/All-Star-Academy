...
const HomeHero = () => {
  return (
    ...
    >
      ...
      <div className="absolute lg:bottom-0 bottom-14  p-4 border-2 border-green-600 bg-[#fff] hover:bg-green-600 hover:text-[#fff] hover:duration-500 font-[600] text-lg uppercase">
