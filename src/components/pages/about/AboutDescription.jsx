...
const AboutDescription = () => {
  ...
  return (
    <div className="px-4 mx-auto max-w-full md:max-w-full lg:max-w-screen-lg md:px-24 lg:px-8">
      <div className="my-10">
        <span className="text-center text-[26px] font-semibold">
          Personalized, advanced approach that causes children to LOVE learning.
        </span>
        <p className="my-8 font-sans ">
        ...
        <div className="mt-14">
          ...
          <button className="btn bg-[#4EBA59] hover:bg-[#4f9756] shadow-custom w-64 h-14 text-lg md:text-lg justify-center text-white my-5 font-medium hover:text-white ml-6">
            BOOK A TOOR NOW
          </button>
        </div>
      </div>
